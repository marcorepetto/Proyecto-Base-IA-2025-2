...
int main(int argc, char** argv) {
    ...
    std::string command = "mkdir -p output/" + folder_name;
    system(command.c_str());

    std::string output_filename = "initialGuess_" + target_filename;

    if (!savePNG(model.getCurrentCanvas(), "output/" + folder_name + "/" + output_filename)) {
